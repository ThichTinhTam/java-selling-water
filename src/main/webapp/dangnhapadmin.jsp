    ...
    <header>
        ...
        <ul id="slide-out" class="side-nav custom-scrollbar">
            ...
            <li>
                ...
                <li><a href="adminController" class="collapsible-header "><i class="far fa-bookmark"></i> Trang chủ<i class="fas fa-angle-down rotate-icon"></i></a></li>
                    <li><a href="loaiadminController" class="collapsible-header "><i class="fas fa-shopping-cart"></i> Quản lý loại<i class="fas fa-angle-down rotate-icon"></i></a></li>
                     <li><a href="nuocadminController" class="collapsible-header "><i class="fas fa-shopping-cart"></i> Quản lý nước<i class="fas fa-angle-down rotate-icon"></i></a></li>
                    <li><a href="danhsachchuyentienController" class="collapsible-header "><i class="fas fa-camera-retro"></i> Danh sách chuyển tiền<i class="fas fa-angle-down rotate-icon"></i></a>
                </ul>
            </li>
            <!--/. Side navigation links -->
        ...
        <nav class="navbar fixed-top navbar-expand-lg  navbar-light scrolling-navbar white">
            <div class="container">
                ...
                <a class="navbar-brand font-weight-bold" href="htnuoc"><strong>Admin</strong></a>
 ...
 <section class="vh-100" style="background-color: #508bfc;">
  <div class="container py-5 h-100">
    ...
    <section class="w-100 p-4 d-flex justify-content-center pb-4">
      <form action="dangnhapadminController" class="form-style" id="login-form" action="/user/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="37uW586AteMrihI8Ewkpz2P936Wn+zU7N5jRFOdDw+2WUupUI7L1MkfztHQxy5vASab70/obiC5PedIGkpkp3A==" />
          <h2>Admin</h2> 
        <!-- Email input -->
...
<div class="g-recaptcha" data-sitekey="6LdFKBMjAAAAADCYVmxuxZooLabzQ9tYmiGjONxi"></div>
        ...
        <div class="text-center">
          <p>Not a admin? <a href="dangkyadmin">Register</a></p>
          <p>or sign up with:</p>
           Đăng nhập với tư cách khách hàng? <a href="dangnhapController">Khách Hàng</a>
        </div>
      </form>
       </div>
      </div>
